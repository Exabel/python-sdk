...
from exabel_data_sdk.client.api.api_client.grpc.holiday_grpc_client import HolidayGrpcClient
...
class HolidayApi:
    ...
    Example:
        ...
        from exabel_data_sdk.stubs.exabel.api.data.v1.holiday_messages_pb2 import (
