...
class PredictionModelRun:
    ...
    Attributes:
        ...
        configuration_source (str):         When using ModelConfiguration.SPECIFIC_RUN,
                                            this specifies the resource name of the run from
                                            which to retrieve the configuration. Example:
                                            "predictionModels/123/runs/2". It is not used for
    ...
    def __init__(
        ...
        if self.configuration == ModelConfiguration.SPECIFIC_RUN and not self.configuration_source:
            raise ValueError(
                "A run resource name, e.g. 'predictionModels/123/runs/4', must be specified when "
                "using ModelConfiguration.SPECIFIC_RUN."
            )
    ...
    def from_proto(model_run: ProtoPredictionModelRun) -> "PredictionModelRun":
        ...
        return PredictionModelRun(
            ...
            configuration_source=model_run.configuration_source or None,
