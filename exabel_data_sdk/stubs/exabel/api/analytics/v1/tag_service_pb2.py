...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'exabel/api/analytics/v1/tag_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GETTAGREQUEST'].fields_by_name['name']._loaded_options = None
    ...
    _globals['_LISTTAGSREQUEST'].fields_by_name['page_size']._serialized_options = b'\x92A#2!Maximum number of tags to return.'
    _globals['_ADDENTITIESREQUEST'].fields_by_name['name']._loaded_options = None
    _globals['_ADDENTITIESREQUEST'].fields_by_name['name']._serialized_options = b'\x92A\r\xca>\n\xfa\x02\x07tagName\xe0A\x02'
    _globals['_REMOVEENTITIESREQUEST'].fields_by_name['name']._loaded_options = None
    _globals['_REMOVEENTITIESREQUEST'].fields_by_name['name']._serialized_options = b'\x92A\r\xca>\n\xfa\x02\x07tagName\xe0A\x02'
    _globals['_LISTTAGENTITIESREQUEST'].fields_by_name['parent']._loaded_options = None
    _globals['_LISTTAGENTITIESREQUEST'].fields_by_name['parent']._serialized_options = b'\x92A\r\xca>\n\xfa\x02\x07tagName\xe0A\x02'
    _globals['_LISTTAGENTITIESREQUEST'].fields_by_name['page_size']._loaded_options = None
    _globals['_LISTTAGENTITIESREQUEST'].fields_by_name['page_size']._serialized_options = b"\x92A'2%Maximum number of entities to return."
    ...
    _globals['_TAGSERVICE'].methods_by_name['AddEntities']._loaded_options = None
    ...
    _globals['_TAGSERVICE'].methods_by_name['RemoveEntities']._loaded_options = None
    ...
    _globals['_TAGSERVICE'].methods_by_name['ListTagEntities']._loaded_options = None
    ...
    _globals['_LISTTAGSREQUEST']._serialized_end = 692
    _globals['_LISTTAGSRESPONSE']._serialized_start = 694
    _globals['_LISTTAGSRESPONSE']._serialized_end = 801
    _globals['_ADDENTITIESREQUEST']._serialized_start = 803
    _globals['_ADDENTITIESREQUEST']._serialized_end = 880
    _globals['_ADDENTITIESRESPONSE']._serialized_start = 882
    _globals['_ADDENTITIESRESPONSE']._serialized_end = 903
    _globals['_REMOVEENTITIESREQUEST']._serialized_start = 905
    _globals['_REMOVEENTITIESREQUEST']._serialized_end = 985
    _globals['_REMOVEENTITIESRESPONSE']._serialized_start = 987
    _globals['_REMOVEENTITIESRESPONSE']._serialized_end = 1011
    _globals['_LISTTAGENTITIESREQUEST']._serialized_start = 1014
    _globals['_LISTTAGENTITIESREQUEST']._serialized_end = 1158
    _globals['_LISTTAGENTITIESRESPONSE']._serialized_start = 1160
    _globals['_LISTTAGENTITIESRESPONSE']._serialized_end = 1252
    _globals['_TAGSERVICE']._serialized_start = 1255
    _globals['_TAGSERVICE']._serialized_end = 2444