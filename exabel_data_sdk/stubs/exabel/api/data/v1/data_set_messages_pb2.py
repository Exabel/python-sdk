...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_DATASET'].fields_by_name['legacy_name']._options = None
    ...
    _globals['_DATASET'].fields_by_name['derived_signals']._options = None
    _globals['_DATASET'].fields_by_name['derived_signals']._serialized_options = b'\x92A.J,["derivedSignals/321", "derivedSignals/432"]'
    _globals['_DATASET'].fields_by_name['highlighted_signals']._options = None
