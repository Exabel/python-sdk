...
class HolidaySpecification(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: builtins.str | None=..., display_name: builtins.str | None=..., holidays: collections.abc.Iterable[global___Holiday] | None=...) -> None:
        ...
...
class Holiday(google.protobuf.message.Message):
    ...
    def __init__(self, *, label: builtins.str | None=..., lower_window: builtins.int | None=..., upper_window: builtins.int | None=..., prior_scale: builtins.float | None=..., dates: collections.abc.Iterable[exabel.api.time.date_pb2.Date] | None=...) -> None:
        ...
