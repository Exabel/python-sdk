...
class TimeSeriesPoint(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "known_time", b"known_time", "time", b"time", "value", b"value"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class TimeSeriesView(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "known_time", b"known_time", "time_range", b"time_range"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class DefaultKnownTime(google___protobuf___message___Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions___Literal["specification", b"specification"]
    ) -> typing_extensions___Literal["current_time", "known_time"]: ...
