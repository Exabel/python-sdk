...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[exabel_dot_api_dot_data_dot_v1_dot_signal__messages__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,])
...
_LISTSIGNALSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='page_size', full_name='exabel.api.data.v1.ListSignalsRequest.page_size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='exabel.api.data.v1.ListSignalsRequest.page_token', index=1,
...
_LISTSIGNALSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signals', full_name='exabel.api.data.v1.ListSignalsResponse.signals', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='exabel.api.data.v1.ListSignalsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_size', full_name='exabel.api.data.v1.ListSignalsResponse.total_size', index=2,
...
_GETSIGNALREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='exabel.api.data.v1.GetSignalRequest.name', index=0,
...
_CREATESIGNALREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signal', full_name='exabel.api.data.v1.CreateSignalRequest.signal', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='create_library_signal', full_name='exabel.api.data.v1.CreateSignalRequest.create_library_signal', index=1,
...
_UPDATESIGNALREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='signal', full_name='exabel.api.data.v1.UpdateSignalRequest.signal', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='exabel.api.data.v1.UpdateSignalRequest.update_mask', index=1,
...
_DELETESIGNALREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='exabel.api.data.v1.DeleteSignalRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DeleteSignalRequest = _reflection.GeneratedProtocolMessageType('DeleteSignalRequest', (_message.Message,), {
