...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TIMESERIESSERVICE.methods_by_name['ImportTimeSeries']._serialized_options = b'\x82\xd3\xe4\x93\x02U",/v1/{parent=entityTypes/*/entities/*}:import:\x01*Z""\x1d/v1/{parent=signals/*}:import:\x01*\x92A\x1b\x12\x19Import time series (bulk)'
    ...
    _TIMESERIESSERVICE._serialized_end = 3349