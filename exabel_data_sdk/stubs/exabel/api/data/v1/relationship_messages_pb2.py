...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_RELATIONSHIPTYPE'].fields_by_name['name']._serialized_options = b'\x92A<J "relationshipTypes/ns.HAS_STORE"\xca>\x17\xfa\x02\x14relationshipTypeName\xe2A\x02\x05\x02'
    ...
    _globals['_RELATIONSHIPTYPE'].fields_by_name['read_only']._serialized_options = b'\xe2A\x01\x03'
    _globals['_RELATIONSHIP'].fields_by_name['parent']._options = None
    _globals['_RELATIONSHIP'].fields_by_name['parent']._serialized_options = b'\x92A<J "relationshipTypes/ns.HAS_STORE"\xca>\x17\xfa\x02\x14relationshipTypeName\xe2A\x01\x02'
    _globals['_RELATIONSHIP'].fields_by_name['from_entity']._options = None
    _globals['_RELATIONSHIP'].fields_by_name['from_entity']._serialized_options = b'\x92A*J("entityTypes/company/entities/F_12345-E"\xe2A\x01\x02'
    _globals['_RELATIONSHIP'].fields_by_name['to_entity']._options = None
    _globals['_RELATIONSHIP'].fields_by_name['to_entity']._serialized_options = b'\x92A2J0"entityTypes/ns.store/entities/ns.some_store_id"\xe2A\x01\x02'
    ...
    _globals['_RELATIONSHIP'].fields_by_name['read_only']._serialized_options = b'\xe2A\x01\x03'
