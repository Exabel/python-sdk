...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_ENTITYTYPE'].fields_by_name['name']._options = None
    _globals['_ENTITYTYPE'].fields_by_name['name']._serialized_options = b'\x92A+J\x15"entityTypes/company"\xca>\x11\xfa\x02\x0eentityTypeName\xe2A\x02\x05\x02'
    _globals['_ENTITYTYPE'].fields_by_name['display_name']._options = None
    _globals['_ENTITYTYPE'].fields_by_name['display_name']._serialized_options = b'\x92A\rJ\x0b"Companies"'
    _globals['_ENTITYTYPE'].fields_by_name['description']._options = None
    _globals['_ENTITYTYPE'].fields_by_name['description']._serialized_options = b'\x92A\x14J\x12"Public companies"'
    _globals['_ENTITYTYPE'].fields_by_name['read_only']._options = None
    _globals['_ENTITYTYPE'].fields_by_name['read_only']._serialized_options = b'\xe2A\x01\x03'
    _globals['_ENTITYTYPE'].fields_by_name['is_associative']._options = None
    _globals['_ENTITYTYPE'].fields_by_name['is_associative']._serialized_options = b'\x92A\x07J\x05false'
    _globals['_ENTITY'].fields_by_name['name']._options = None
    ...
    _globals['_ENTITY'].fields_by_name['display_name']._options = None
    _globals['_ENTITY'].fields_by_name['display_name']._serialized_options = b'\x92A\rJ\x0b"My Entity"'
    _globals['_ENTITY'].fields_by_name['description']._options = None
    _globals['_ENTITY'].fields_by_name['description']._serialized_options = b'\x92A&J$"This is a description of My Entity"'
    _globals['_ENTITY'].fields_by_name['read_only']._options = None
    _globals['_ENTITY'].fields_by_name['read_only']._serialized_options = b'\xe2A\x01\x03'
