...
isort:skip_file
"""
from exabel.api.data.v1.relationship_messages_pb2 import Relationship as exabel___api___data___v1___relationship_messages_pb2___Relationship, RelationshipType as exabel___api___data___v1___relationship_messages_pb2___RelationshipType
...
class ListRelationshipTypesResponse(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationship_types: typing___Optional[typing___Iterable[exabel___api___data___v1___relationship_messages_pb2___RelationshipType]]=None, next_page_token: typing___Optional[typing___Text]=None, total_size: typing___Optional[builtin___int]=None) -> None:
        ...
...
class CreateRelationshipTypeRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationship_type: typing___Optional[exabel___api___data___v1___relationship_messages_pb2___RelationshipType]=None) -> None:
        ...
...
class UpdateRelationshipTypeRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationship_type: typing___Optional[exabel___api___data___v1___relationship_messages_pb2___RelationshipType]=None, update_mask: typing___Optional[google___protobuf___field_mask_pb2___FieldMask]=None, allow_missing: typing___Optional[builtin___bool]=None) -> None:
        ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u'allow_missing', b'allow_missing', u'relationship_type', b'relationship_type', u'update_mask', b'update_mask']) -> None:
        ...
...
class ListRelationshipsRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, parent: typing___Optional[typing___Text]=None, from_entity: typing___Optional[typing___Text]=None, to_entity: typing___Optional[typing___Text]=None, page_size: typing___Optional[builtin___int]=None, page_token: typing___Optional[typing___Text]=None) -> None:
        ...
...
class ListRelationshipsResponse(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationships: typing___Optional[typing___Iterable[exabel___api___data___v1___relationship_messages_pb2___Relationship]]=None, next_page_token: typing___Optional[typing___Text]=None, total_size: typing___Optional[builtin___int]=None) -> None:
        ...
...
class GetRelationshipRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, parent: typing___Optional[typing___Text]=None, from_entity: typing___Optional[typing___Text]=None, to_entity: typing___Optional[typing___Text]=None) -> None:
        ...
...
class CreateRelationshipRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationship: typing___Optional[exabel___api___data___v1___relationship_messages_pb2___Relationship]=None) -> None:
        ...
...
class UpdateRelationshipRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, relationship: typing___Optional[exabel___api___data___v1___relationship_messages_pb2___Relationship]=None, update_mask: typing___Optional[google___protobuf___field_mask_pb2___FieldMask]=None, allow_missing: typing___Optional[builtin___bool]=None) -> None:
        ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u'allow_missing', b'allow_missing', u'relationship', b'relationship', u'update_mask', b'update_mask']) -> None:
        ...
