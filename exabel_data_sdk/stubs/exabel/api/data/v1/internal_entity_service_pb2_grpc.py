...
class InternalEntityServiceStub(object):
    """Manages entity types in the Data API, for internal usage. This service is
    deprecated and replaced by the corresponding operations in EntityService.
    """
    ...
    def __init__(self, channel):
        ...
        """
        self.CreateEntityType = channel.unary_unary('/exabel.api.data.v1.InternalEntityService/CreateEntityType', request_serializer=exabel_dot_api_dot_data_dot_v1_dot_entity__service__pb2.CreateEntityTypeRequest.SerializeToString, response_deserializer=exabel_dot_api_dot_data_dot_v1_dot_entity__messages__pb2.EntityType.FromString)
        self.UpdateEntityType = channel.unary_unary('/exabel.api.data.v1.InternalEntityService/UpdateEntityType', request_serializer=exabel_dot_api_dot_data_dot_v1_dot_entity__service__pb2.UpdateEntityTypeRequest.SerializeToString, response_deserializer=exabel_dot_api_dot_data_dot_v1_dot_entity__messages__pb2.EntityType.FromString)
...
def add_InternalEntityServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'CreateEntityType': grpc.unary_unary_rpc_method_handler(servicer.CreateEntityType, request_deserializer=exabel_dot_api_dot_data_dot_v1_dot_entity__service__pb2.CreateEntityTypeRequest.FromString, response_serializer=exabel_dot_api_dot_data_dot_v1_dot_entity__messages__pb2.EntityType.SerializeToString), 'UpdateEntityType': grpc.unary_unary_rpc_method_handler(servicer.UpdateEntityType, request_deserializer=exabel_dot_api_dot_data_dot_v1_dot_entity__service__pb2.UpdateEntityTypeRequest.FromString, response_serializer=exabel_dot_api_dot_data_dot_v1_dot_entity__messages__pb2.EntityType.SerializeToString)}
