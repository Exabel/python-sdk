...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'exabel/api/data/v1/namespaces_messages.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NAMESPACE'].fields_by_name['name']._serialized_options = b'\xe0A\x03'
    _globals['_NAMESPACE'].fields_by_name['writeable']._loaded_options = None
    _globals['_NAMESPACE'].fields_by_name['writeable']._serialized_options = b'\xe0A\x03'
    _globals['_NAMESPACE']._serialized_start = 101
    _globals['_NAMESPACE']._serialized_end = 155