...
class EntityType(google___protobuf___message___Message):
    ...
    def __init__(self, *, name: typing___Optional[typing___Text]=None, display_name: typing___Optional[typing___Text]=None, description: typing___Optional[typing___Text]=None, read_only: typing___Optional[builtin___bool]=None, is_associative: typing___Optional[builtin___bool]=None) -> None:
        ...
...
class Entity(google___protobuf___message___Message):
    ...
    def __init__(self, *, name: typing___Optional[typing___Text]=None, display_name: typing___Optional[typing___Text]=None, description: typing___Optional[typing___Text]=None, read_only: typing___Optional[builtin___bool]=None, properties: typing___Optional[google___protobuf___struct_pb2___Struct]=None) -> None:
        ...
