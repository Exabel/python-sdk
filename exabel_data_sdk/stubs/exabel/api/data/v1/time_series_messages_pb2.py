...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TIMESERIES.fields_by_name['units']._options = None
    _TIMESERIES.fields_by_name['units']._serialized_options = b'\xe2A\x01\x01'
    ...
    _UNITS.fields_by_name['units']._options = None
    _UNITS.fields_by_name['units']._serialized_options = b'\xe2A\x02\x01\x05'
    _UNITS.fields_by_name['multiplier']._options = None
    _UNITS.fields_by_name['multiplier']._serialized_options = b'\xe2A\x02\x01\x05'
    _UNITS.fields_by_name['description']._options = None
    _UNITS.fields_by_name['description']._serialized_options = b'\xe2A\x01\x01'
    _UNIT.fields_by_name['dimension']._options = None
    _UNIT.fields_by_name['dimension']._serialized_options = b'\xe2A\x02\x01\x05'
    _UNIT.fields_by_name['unit']._options = None
    _UNIT.fields_by_name['unit']._serialized_options = b'\xe2A\x02\x02\x05'
    _UNIT.fields_by_name['exponent']._options = None
    _UNIT.fields_by_name['exponent']._serialized_options = b'\xe2A\x02\x01\x05'
