...
class RelationshipType(google___protobuf___message___Message):
    ...
    is_ownership: builtin___bool = ...

    @property
    def properties(self) -> google___protobuf___struct_pb2___Struct:
        ...

    def __init__(self, *, name: typing___Optional[typing___Text]=None, description: typing___Optional[typing___Text]=None, read_only: typing___Optional[builtin___bool]=None, is_ownership: typing___Optional[builtin___bool]=None, properties: typing___Optional[google___protobuf___struct_pb2___Struct]=None) -> None:
        ...

    def HasField(self, field_name: typing_extensions___Literal[u'properties', b'properties']) -> builtin___bool:
        ...

    def ClearField(self, field_name: typing_extensions___Literal[u'description', b'description', u'is_ownership', b'is_ownership', u'name', b'name', u'properties', b'properties', u'read_only', b'read_only']) -> None:
        ...
