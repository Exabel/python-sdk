...
isort:skip_file
"""
from exabel.api.data.v1.signal_messages_pb2 import Signal as exabel___api___data___v1___signal_messages_pb2___Signal
...
class ListSignalsResponse(google___protobuf___message___Message):
    ...
    def __init__(self, *, signals: typing___Optional[typing___Iterable[exabel___api___data___v1___signal_messages_pb2___Signal]]=None, next_page_token: typing___Optional[typing___Text]=None, total_size: typing___Optional[builtin___int]=None) -> None:
        ...
...
class CreateSignalRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, signal: typing___Optional[exabel___api___data___v1___signal_messages_pb2___Signal]=None, create_library_signal: typing___Optional[builtin___bool]=None) -> None:
        ...
...
class UpdateSignalRequest(google___protobuf___message___Message):
    ...
    def __init__(self, *, signal: typing___Optional[exabel___api___data___v1___signal_messages_pb2___Signal]=None, update_mask: typing___Optional[google___protobuf___field_mask_pb2___FieldMask]=None, allow_missing: typing___Optional[builtin___bool]=None, create_library_signal: typing___Optional[builtin___bool]=None) -> None:
        ...

    def HasField(self, field_name: typing_extensions___Literal[u'signal', b'signal', u'update_mask', b'update_mask']) -> builtin___bool:
        ...

    def ClearField(self, field_name: typing_extensions___Literal[u'allow_missing', b'allow_missing', u'create_library_signal', b'create_library_signal', u'signal', b'signal', u'update_mask', b'update_mask']) -> None:
        ...
