...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_DERIVEDSIGNAL'].fields_by_name['data_sets']._options = None
    _globals['_DERIVEDSIGNAL'].fields_by_name['data_sets']._serialized_options = b'\xe0A\x03'
    _globals['_DERIVEDSIGNAL'].fields_by_name['display_name']._options = None
    ...
    _globals['_DERIVEDSIGNAL'].fields_by_name['downsampling_method']._options = None
    _globals['_DERIVEDSIGNAL'].fields_by_name['downsampling_method']._serialized_options = b'\xe0A\x03'
    _globals['_DERIVEDSIGNAL'].fields_by_name['change']._options = None
    _globals['_DERIVEDSIGNAL'].fields_by_name['change']._serialized_options = b'\xe0A\x03'
    _globals['_DERIVEDSIGNAL'].fields_by_name['entity_set']._options = None
    ...
    _globals['_DERIVEDSIGNAL']._serialized_end = 1014
    _globals['_DERIVEDSIGNALS']._serialized_start = 1016
    _globals['_DERIVEDSIGNALS']._serialized_end = 1092