...
class JSONSchema(google___protobuf___message___Message):
    ...
    class FieldConfiguration(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        path_param_name: typing___Text = ...

        def __init__(self, *, path_param_name: typing___Optional[typing___Text]=None) -> None:
            ...

        def ClearField(self, field_name: typing_extensions___Literal[u'path_param_name', b'path_param_name']) -> None:
            ...
    type___FieldConfiguration = FieldConfiguration
    ref: typing___Text = ...
    title: typing___Text = ...
    description: typing___Text = ...
    default: typing___Text = ...
    ...
    @property
    def field_configuration(self) -> type___JSONSchema.FieldConfiguration:
        ...

    def __init__(self, *, ref: typing___Optional[typing___Text]=None, title: typing___Optional[typing___Text]=None, description: typing___Optional[typing___Text]=None, default: typing___Optional[typing___Text]=None, read_only: typing___Optional[builtin___bool]=None, example: typing___Optional[typing___Text]=None, multiple_of: typing___Optional[builtin___float]=None, maximum: typing___Optional[builtin___float]=None, exclusive_maximum: typing___Optional[builtin___bool]=None, minimum: typing___Optional[builtin___float]=None, exclusive_minimum: typing___Optional[builtin___bool]=None, max_length: typing___Optional[builtin___int]=None, min_length: typing___Optional[builtin___int]=None, pattern: typing___Optional[typing___Text]=None, max_items: typing___Optional[builtin___int]=None, min_items: typing___Optional[builtin___int]=None, unique_items: typing___Optional[builtin___bool]=None, max_properties: typing___Optional[builtin___int]=None, min_properties: typing___Optional[builtin___int]=None, required: typing___Optional[typing___Iterable[typing___Text]]=None, array: typing___Optional[typing___Iterable[typing___Text]]=None, type: typing___Optional[typing___Iterable[type___JSONSchema.JSONSchemaSimpleTypesValue]]=None, format: typing___Optional[typing___Text]=None, enum: typing___Optional[typing___Iterable[typing___Text]]=None, field_configuration: typing___Optional[type___JSONSchema.FieldConfiguration]=None) -> None:
        ...

    def HasField(self, field_name: typing_extensions___Literal[u'field_configuration', b'field_configuration']) -> builtin___bool:
        ...

    def ClearField(self, field_name: typing_extensions___Literal[u'array', b'array', u'default', b'default', u'description', b'description', u'enum', b'enum', u'example', b'example', u'exclusive_maximum', b'exclusive_maximum', u'exclusive_minimum', b'exclusive_minimum', u'field_configuration', b'field_configuration', u'format', b'format', u'max_items', b'max_items', u'max_length', b'max_length', u'max_properties', b'max_properties', u'maximum', b'maximum', u'min_items', b'min_items', u'min_length', b'min_length', u'min_properties', b'min_properties', u'minimum', b'minimum', u'multiple_of', b'multiple_of', u'pattern', b'pattern', u'read_only', b'read_only', u'ref', b'ref', u'required', b'required', u'title', b'title', u'type', b'type', u'unique_items', b'unique_items']) -> None:
        ...
