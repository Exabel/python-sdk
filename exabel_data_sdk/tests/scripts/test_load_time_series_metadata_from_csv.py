...
class TestUploadTimeSeriesMetadata(unittest.TestCase):
    ...
    def test_read_file__description(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_description.csv",
        ]
    ...
    def test_read_file__currency(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_currency.csv",
        ]
        script = LoadTimeSeriesMetaDataFromFile(args)
        script.run_script(self.client, script.parse_arguments())
    ...
    def test_read_file__unit(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_unit.csv",
        ]
        script = LoadTimeSeriesMetaDataFromFile(args)
        script.run_script(self.client, script.parse_arguments())
        ...
        self.assertEqual(
            ts,
            series_by_name["entityTypes/company/entities/company_A/signals/ns.signal3"],
        )

    def test_read_file__unit_and_currency(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_unit_and_currency.csv",
        ]
        script = LoadTimeSeriesMetaDataFromFile(args)
        script.run_script(self.client, script.parse_arguments())
    ...
    def test_read_file__invalid(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_invalid.csv",
        ]
        script = LoadTimeSeriesMetaDataFromFile(args)
    ...
    def test_read_file__invalid2(self):
        args = common_args + [
            "--filename",
            "./exabel_data_sdk/tests/resources/data/timeseries_metadata_invalid2.csv",
        ]
        script = LoadTimeSeriesMetaDataFromFile(args)
