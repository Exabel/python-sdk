...
from exabel.client.api.bulk_insert import BulkInsertFailedError
from exabel.client.api.data_classes.relationship import Relationship
from exabel.client.api.search_service import (
...
from exabel.util.case_insensitive_column import get_case_insensitive_column
from exabel.util.exceptions import TypeConversionError
from exabel.util.resource_name_normalization import to_entity_resource_names
...
class CsvRelationshipLoader:
    ...
    def load_relationships(
        ...
        *,
        ...
        if isinstance(relationships_dfs, pd.DataFrame):
