from exabel.client.api.api_client.data_set_api_client import DataSetApiClient
...
from exabel.stubs.exabel.api.data.v1.all_pb2_grpc import DataSetServiceStub
