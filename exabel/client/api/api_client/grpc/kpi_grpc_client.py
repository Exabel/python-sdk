...
from exabel.client.api.api_client.kpi_api_client import KpiApiClient
...
from exabel.stubs.exabel.api.analytics.v1.kpi_service_pb2_grpc import KpiServiceStub
