from exabel.client.api.api_client.calendar_api_client import CalendarApiClient
...
from exabel.stubs.exabel.api.data.v1.calendar_service_pb2_grpc import CalendarServiceStub
...
class CalendarGrpcClient(CalendarApiClient, BaseGrpcClient):
    ...
    def get_company_calendar(self, request: GetCompanyCalendarRequest) -> CompanyCalendar:
        return self.stub.GetCompanyCalendar(
