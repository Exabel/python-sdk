from exabel.client.api.api_client.derived_signal_api_client import DerivedSignalApiClient
...
from exabel.stubs.exabel.api.analytics.v1.all_pb2_grpc import DerivedSignalServiceStub
