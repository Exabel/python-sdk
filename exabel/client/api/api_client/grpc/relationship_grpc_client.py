...
from exabel.client.api.api_client.relationship_api_client import RelationshipApiClient
...
from exabel.stubs.exabel.api.data.v1.all_pb2_grpc import RelationshipServiceStub
