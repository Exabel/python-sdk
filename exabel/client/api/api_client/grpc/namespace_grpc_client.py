...
from exabel.client.api.api_client.namespace_api_client import NamespaceApiClient
...
from exabel.stubs.exabel.api.data.v1.all_pb2_grpc import NamespaceServiceStub
