...
# source: exabel/api/data/v1/import_job_service.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'exabel/api/data/v1/import_job_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\026com.exabel.api.data.v1B\026ImportJobsServiceProtoP\001Z\026exabel.com/api/data/v1'
  _globals['_RUNTASKREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_RUNTASKREQUEST'].fields_by_name['name']._serialized_options = b'\222A\016\312>\013\372\002\010taskName\340A\002'
  _globals['_IMPORTJOBSERVICE'].methods_by_name['RunTask']._loaded_options = None
  _globals['_IMPORTJOBSERVICE'].methods_by_name['RunTask']._serialized_options = b'\222A\021\022\017Run import task\202\323\344\223\002\033\"\026/v1/{name=tasks/*}:run:\001*'
