...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'exabel/api/data/v1/signal_messages.proto'
)
...
from . import common_messages_pb2 as exabel_dot_api_dot_data_dot_v1_dot_common__messages__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\026com.exabel.api.data.v1B\023SignalMessagesProtoP\001Z\026exabel.com/api/data/v1'
  _globals['_SIGNAL'].fields_by_name['name']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['name']._serialized_options = b'\222A%J\023\"signals/ns.signal\"\312>\r\372\002\nsignalName\340A\005\340A\002'
  _globals['_SIGNAL'].fields_by_name['entity_type']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['entity_type']._serialized_options = b'\030\001'
  _globals['_SIGNAL'].fields_by_name['display_name']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['display_name']._serialized_options = b'\222A\rJ\013\"My signal\"'
  _globals['_SIGNAL'].fields_by_name['description']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['description']._serialized_options = b'\222A\027J\025\"Describes my signal\"'
  _globals['_SIGNAL'].fields_by_name['read_only']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['read_only']._serialized_options = b'\340A\003'
  _globals['_SIGNAL'].fields_by_name['entity_types']._loaded_options = None
  _globals['_SIGNAL'].fields_by_name['entity_types']._serialized_options = b'\222A2J0[\"entityTypes/ns.type1\", \"entityTypes/ns.type2\"]\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['name']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['name']._serialized_options = b'\222A-J\024\"derivedSignals/321\"\312>\024\372\002\021derivedSignalName\340A\005\340A\002'
  _globals['_DERIVEDSIGNAL'].fields_by_name['data_sets']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['data_sets']._serialized_options = b'\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['display_name']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['display_name']._serialized_options = b'\222A\rJ\013\"My signal\"\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['label']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['label']._serialized_options = b'\222A\025J\023\"signal_expression\"\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['description']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['description']._serialized_options = b'\222A\027J\025\"Describes my signal\"\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['downsampling_method']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['downsampling_method']._serialized_options = b'\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['change']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['change']._serialized_options = b'\340A\003'
  _globals['_DERIVEDSIGNAL'].fields_by_name['entity_set']._loaded_options = None
  _globals['_DERIVEDSIGNAL'].fields_by_name['entity_set']._serialized_options = b'\340A\003'
