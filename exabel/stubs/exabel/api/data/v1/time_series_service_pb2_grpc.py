...
from . import time_series_service_pb2 as exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in exabel/api/data/v1/time_series_service_pb2_grpc.py depends on'
...
class TimeSeriesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ImportTimeSeries = channel.unary_unary(
                '/exabel.api.data.v1.TimeSeriesService/ImportTimeSeries',
                request_serializer=exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesRequest.SerializeToString,
                response_deserializer=exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesResponse.FromString,
                _registered_method=True)
...
def add_TimeSeriesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ImportTimeSeries': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesRequest.FromString,
                    response_serializer=exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesResponse.SerializeToString,
            ),
            'BatchDeleteTimeSeriesPoints': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.BatchDeleteTimeSeriesPointsResponse.SerializeToString,
            ),
...
class TimeSeriesService(object):
    ...
    def ImportTimeSeries(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/exabel.api.data.v1.TimeSeriesService/ImportTimeSeries',
            exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesRequest.SerializeToString,
            exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.ImportTimeSeriesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def BatchDeleteTimeSeriesPoints(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            exabel_dot_api_dot_data_dot_v1_dot_time__series__service__pb2.BatchDeleteTimeSeriesPointsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
