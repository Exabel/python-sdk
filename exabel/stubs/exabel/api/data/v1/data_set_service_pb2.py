...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'exabel/api/data/v1/data_set_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\026com.exabel.api.data.v1B\023DataSetServiceProtoP\001Z\026exabel.com/api/data/v1'
  _globals['_GETDATASETREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETDATASETREQUEST'].fields_by_name['name']._serialized_options = b'\222A\021\312>\016\372\002\013dataSetName\340A\002'
  _globals['_CREATEDATASETREQUEST'].fields_by_name['data_set']._loaded_options = None
  _globals['_CREATEDATASETREQUEST'].fields_by_name['data_set']._serialized_options = b'\340A\002'
  _globals['_UPDATEDATASETREQUEST'].fields_by_name['data_set']._loaded_options = None
  _globals['_UPDATEDATASETREQUEST'].fields_by_name['data_set']._serialized_options = b'\340A\002'
  _globals['_DELETEDATASETREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEDATASETREQUEST'].fields_by_name['name']._serialized_options = b'\222A\021\312>\016\372\002\013dataSetName\340A\002'
  _globals['_DATASETSERVICE'].methods_by_name['ListDataSets']._loaded_options = None
  _globals['_DATASETSERVICE'].methods_by_name['ListDataSets']._serialized_options = b'\222A\020\022\016List data sets\202\323\344\223\002\016\022\014/v1/dataSets'
  _globals['_DATASETSERVICE'].methods_by_name['GetDataSet']._loaded_options = None
  _globals['_DATASETSERVICE'].methods_by_name['GetDataSet']._serialized_options = b'\222A\016\022\014Get data set\202\323\344\223\002\027\022\025/v1/{name=dataSets/*}'
  _globals['_DATASETSERVICE'].methods_by_name['CreateDataSet']._loaded_options = None
  _globals['_DATASETSERVICE'].methods_by_name['CreateDataSet']._serialized_options = b'\222A\021\022\017Create data set\202\323\344\223\002\030\"\014/v1/dataSets:\010data_set'
  _globals['_DATASETSERVICE'].methods_by_name['UpdateDataSet']._loaded_options = None
  _globals['_DATASETSERVICE'].methods_by_name['UpdateDataSet']._serialized_options = b'\222A\021\022\017Update data set\202\323\344\223\002*2\036/v1/{data_set.name=dataSets/*}:\010data_set'
  _globals['_DATASETSERVICE'].methods_by_name['DeleteDataSet']._loaded_options = None
  _globals['_DATASETSERVICE'].methods_by_name['DeleteDataSet']._serialized_options = b'\222A\021\022\017Delete data set\202\323\344\223\002\027*\025/v1/{name=dataSets/*}'
