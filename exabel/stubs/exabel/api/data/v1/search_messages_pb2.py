...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'exabel/api/data/v1/search_messages.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\026com.exabel.api.data.v1B\023SearchMessagesProtoP\001Z\026exabel.com/api/data/v1'
  _globals['_SEARCHTERM'].fields_by_name['field']._loaded_options = None
  _globals['_SEARCHTERM'].fields_by_name['field']._serialized_options = b'\222A\010J\006\"text\"\340A\002'
  _globals['_SEARCHTERM'].fields_by_name['query']._loaded_options = None
  _globals['_SEARCHTERM'].fields_by_name['query']._serialized_options = b'\222A\rJ\013\"microsoft\"\340A\002'
