...
from . import namespace_service_pb2 as exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in exabel/api/data/v1/namespace_service_pb2_grpc.py depends on'
...
class NamespaceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListNamespaces = channel.unary_unary(
                '/exabel.api.data.v1.NamespaceService/ListNamespaces',
                request_serializer=exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2.ListNamespacesRequest.SerializeToString,
...
def add_NamespaceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListNamespaces': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2.ListNamespacesRequest.FromString,
                    response_serializer=exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2.ListNamespacesResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'exabel.api.data.v1.NamespaceService', rpc_method_handlers)
...
class NamespaceService(object):
    ...
    def ListNamespaces(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/exabel.api.data.v1.NamespaceService/ListNamespaces',
            exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2.ListNamespacesRequest.SerializeToString,
            exabel_dot_api_dot_data_dot_v1_dot_namespace__service__pb2.ListNamespacesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
