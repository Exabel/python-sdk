...
# source: exabel/api/management/v1/user_service.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'exabel/api/management/v1/user_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\034com.exabel.api.management.v1B\020UserServiceProtoP\001Z\034exabel.com/api/management/v1'
  _globals['_USERSERVICE'].methods_by_name['ListGroups']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['ListGroups']._serialized_options = b'\222A\r\022\013List groups\202\323\344\223\002\014\022\n/v1/groups'
  _globals['_USERSERVICE'].methods_by_name['ListUsers']._loaded_options = None
  _globals['_USERSERVICE'].methods_by_name['ListUsers']._serialized_options = b'\222A\014\022\nList users\202\323\344\223\002\013\022\t/v1/users'
