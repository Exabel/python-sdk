...
class TestUploadTimeSeries(unittest.TestCase):
    ...
    def check_import(
        ...
        *expected_calls,
        ...
        assert len(expected_calls) == len(call_args_list)
    ...
    def test_read_excel__entities_in_columns_1(self):
        self.check_import(
            "./exabel/tests/resources/data/entities_in_columns_example_1.xlsx",
            [
                pd.Series(
                    [1, 2, 3],
    ...
    def test_read_excel__entities_in_columns_2(self):
        self.check_import(
            "./exabel/tests/resources/data/entities_in_columns_example_2.xlsx",
            [
                pd.Series(
                    [1, 2],
                    pd.date_range("2020-10-10", periods=2, tz=tz.tzutc()),
    ...
    def test_read_excel__companies_in_columns_1(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/companies_in_columns_example_1.xlsx",
            [
                pd.Series(
                    [1, 2, 3],
                    pd.date_range("2020-10-10", periods=3, tz=tz.tzutc()),
    ...
    def test_read_excel__signal_in_row_1(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/signal_in_row_example_1.xlsx",
            [
                pd.Series(
    ...
    def test_read_excel__signal_in_row_1__override_entity_type__with_identifier_type(self):
        ...
        assert "entityTypes/company" == search_kwargs.get("entity_type")
    ...
    def test_read_excel__signal_in_row_2(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/signal_in_row_example_2.xlsx",
            [
                pd.Series(
                    [1, 1.1, 1.2, math.nan, 1.4],
    ...
    def test_read_excel__signal_in_row_3(self):
        self.check_import(
            "./exabel/tests/resources/data/signal_in_row_example_3.xlsx",
            [
                pd.Series(
                    [1],
    ...
    def test_read_excel__signal_in_row_4__global_entity(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/signal_in_row_example_4.xlsx",
            [
                pd.Series(
                    [1, 1.1, 1.2, math.nan, 1.4],
                    pd.MultiIndex.from_tuples(
    ...
    def test_read_excel__signal_in_row_6__namespaced_entity_type(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/signal_in_row_example_6.xlsx",
            [
                pd.Series(
                    [1, 1.1, 1.4],
                    index=[
    ...
    def test_read_excel__signal_in_column_example_1(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/signal_in_column_example_1.xlsx",
            [
                pd.Series(
                    [1.2, 1.3, 1.4, 1.5],
    ...
    def test_read_excel__signal_in_column_example_3__global_entity(self):
        self.check_import(
            "./exabel/tests/resources/data/signal_in_column_example_3.xlsx",
            [
                pd.Series(
    ...
    def test_read_excel__multiple_sheets_1(self):
        ...
        self.check_import(
            "./exabel/tests/resources/data/multiple_sheets_example_1.xlsx",
            [
                pd.Series(
    ...
    def test_read_excel__no_data_rows_1(self):
        self.check_import("./exabel/tests/resources/data/no_data_1.xlsx", [])
    ...
    def test_read_excel__no_data_rows_2(self):
        self.check_import("./exabel/tests/resources/data/no_data_2.xlsx", [])
        result = self.client.signal_api.list_signals()
        self.assertCountEqual(
            ["signals/ns.signal1", "signals/ns.signal2"], [s.name for s in result]
        )
    ...
    def test_read_excel__no_data_rows_3(self):
        self.check_import("./exabel/tests/resources/data/no_data_3.xlsx", [])
        result = self.client.signal_api.list_signals()
        self.assertCountEqual(
            ["signals/ns.signal1", "signals/ns.signal2"], [s.name for s in result]
        )
    ...
    def test_read_excel__no_data_rows_4(self):
        self.check_import("./exabel/tests/resources/data/no_data_4.xlsx", [])
        result = self.client.signal_api.list_signals()
        assert 0 == result.total_size
