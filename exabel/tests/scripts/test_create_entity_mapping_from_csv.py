...
from exabel.scripts.create_entity_mapping_from_csv import CreateEntityMappingFromCsv
...
class TestCreateEntityMappingFromCsv(unittest.TestCase):
    ...
    def test_create_mapping_ticker(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_ticker.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "mic": "XNAS", "ticker": "C"} == kwargs, (
        ...
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "mic": "XNYS", "ticker": "C"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "mic": "XASE", "ticker": "C"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "mic": "XNYS", "ticker": "M"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "mic": "XHKG", "ticker": "001"} == kwargs, (
            "Arguments not as expected"
        )
    ...
    def test_create_mapping_isin(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_isin.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[0]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "isin": "NO0010096985"} == kwargs, (
            "Arguments not as expected"
        )
    ...
    def test_create_mapping_factset_identifier(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_factset_identifier.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[0]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "factset_identifier": "0MXNWD-E"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[1]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "factset_identifier": "DT699H-S"} == kwargs, (
            "Arguments not as expected"
        )
    ...
    def test_create_mapping_bloomberg_ticker(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_bloomberg_ticker.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[0]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "bloomberg_ticker": "AAPL US"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[1]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "bloomberg_ticker": "AMZN US"} == kwargs, (
            "Arguments not as expected"
        )
    ...
    def test_create_mapping_figi(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_figi.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[0]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "figi": "BBG000B9Y5X2"} == kwargs, (
            "Arguments not as expected"
        )
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[1]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "figi": "BBG001S5N8V8"} == kwargs, (
            "Arguments not as expected"
        )
    ...
    def test_create_mapping_cusip(self):
        args = [
            "script-name",
            "--filename-input",
            "./exabel/tests/resources/data/mapping_cusip.csv",
            "--filename-output",
            self.temp_file.name,
            "--api-key",
            "123",
        ...
        call_args = self.client.entity_api.search_for_entities.call_args_list[0]
        _, kwargs = call_args
        assert {"entity_type": "entityTypes/company", "cusip": "Y01234567"} == kwargs, (
            "Arguments not as expected"
        )
