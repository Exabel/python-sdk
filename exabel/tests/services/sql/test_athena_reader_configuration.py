...
from exabel.services.sql.athena_reader_configuration import (
...
class TestAthenaReaderConfiguration(unittest.TestCase):
    ...
    def test_get_connection_string__minimal(self):
        assert (
            ...
            "&s3_staging_dir=staging%2Fdir" == self.config_minimal.get_connection_string()
        )
    ...
    def test_get_connection_string__with_profile(self):
        ...
        assert (
            "awsathena+arrow://:@athena.region.amazonaws.com:443/?unload=true"
            "&s3_staging_dir=staging%2Fdir&profile_name=profile" == config.get_connection_string()
        )
