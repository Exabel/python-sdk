...
from exabel.tests.client.api.mock_entity_api import MockEntityApi
...
class TestEntityApi:
    def test_upsert(self):
        ...
        assert expected == created_entity
        updated_entity = entity_api.upsert_entity(expected)
        assert expected == updated_entity
    ...
    def test_get_entity_type_iterator(self):
        ...
        assert 2555 == len(entity_types)
        assert [entity_type] * 2555 == entity_types
    ...
    def test_get_entities_iterator(self):
        ...
        assert 1100 == len(entities)
        assert [entity] * 1100 == entities
